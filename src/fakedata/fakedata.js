...
const Learnings = {
  ...
  points: [
    { text: "Create their own Python Programs", checked: true },
    { text: "Become an experienced Python Programmer", checked: true },
    { text: "Parse the Web and Create their own Games", checked: true },
    { text: "Build production-ready applications", checked: true },
  ],
  // prefix: "✅",
};
